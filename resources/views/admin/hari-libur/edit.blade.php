    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="mt-1 text-black-70 text-sm font-medium">Perbarui tanggal dan keterangan libur.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl mx-auto">
            <div class="bg-white dark:bg-slate-900 overflow-hidden shadow-soft rounded-3xl border border-slate-100/70 dark:border-white/10">
                <div class="p-8 sm:p-10">
                    <form action="{{ route('admin.hari-libur.update', $hariLibur->id) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="tanggal" class="block w-full pl-10 focus:ring-rose-500 focus:border-rose-500" type="date" name="tanggal" :value="old('tanggal', $hariLibur->tanggal)" required />
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="keterangan" class="block w-full pl-10" type="text" name="keterangan" :value="old('keterangan', $hariLibur->keterangan)" placeholder="Contoh: Libur Nasional / Cuti Bersama" />
                                </div>
