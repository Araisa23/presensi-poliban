        ...
        <div class="bg-white dark:bg-slate-900 overflow-hidden 
            ...
            <form method="POST"
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="1" {{ old('status', $pengumuman->status) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status', $pengumuman->status) == '0' ? 'selected' : '' }}>Nonaktif</option>
                ...
                <div class="px-8 py-5 flex justify-end gap-3">
                    ...
                    {{-- BACK BUTTON --}}
                    <x-back-button href="{{ route('admin.pengumuman.index') }}">
                        Kembali
                    </x-back-button>
